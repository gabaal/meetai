...
import { BadgeIcon, CircleCheckIcon, CircleXIcon, ClockArrowUpIcon, ClockFadingIcon, CornerDownRightIcon, LoaderIcon, VideoIcon } from "lucide-react"
            ...
            <div className="flex flex-col gap-y-1">
                ...
                <div className="flex items-center gap-x-2">
                    <div className="flex items-center gap-x-1">
                        ...
                        <span className="text-sm text-muted-foreground max-w-[200px] truncate capitalize">{row.original.agent.name}
                        </span>
                    </div>
                    <GeneratedAvatar
